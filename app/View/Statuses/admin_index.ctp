<div class="statuses index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('status_time'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($status['Status']['status_time']); ?>&nbsp;</td>
		<td><?php echo h($status['Status']['content']); ?>&nbsp;</td>
		<td><?php echo h($status['Status']['user_id']); ?>&nbsp;</td>
		<td class="actions">
