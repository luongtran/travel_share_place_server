<div class="images index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('typeimage_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($image['Image']['typeimage_id']); ?>&nbsp;</td>
		<td><?php echo h($image['Image']['user_id']); ?>&nbsp;</td>
		<td><?php echo h($image['Image']['place_id']); ?>&nbsp;</td>
		<td><?php echo h($image['Image']['src']); ?>&nbsp;</td>
		<td class="actions">
