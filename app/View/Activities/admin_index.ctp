<div class="activities index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('activity_time'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($activities as $activity): ?>
	<tr>
		<td><?php echo h($activity['Activity']['id']); ?>&nbsp;</td>
		<td><?php echo h($activity['Activity']['user_id']); ?>&nbsp;</td>
		<td><?php echo h($activity['Activity']['category_id']); ?>&nbsp;</td>
		<td><?php echo h($activity['Activity']['event_id']); ?>&nbsp;</td>
		<td><?php echo h($activity['Activity']['activity_id']); ?>&nbsp;</td>
		<td><?php echo h($activity['Activity']['activity_time']); ?>&nbsp;</td>
		<td class="actions">
